/*
  ...
  - Added the required column `pushlishedAt` to the `posts` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `posts` ADD COLUMN `createdAt` DATETIME(3) NOT NULL,
    ADD COLUMN `pushlishedAt` DATETIME(3) NOT NULL,
